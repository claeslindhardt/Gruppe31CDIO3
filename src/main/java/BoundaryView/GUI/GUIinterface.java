...
public class GUIinterface implements UserInterfaceKontrakt {
    ...
    public void spillerPosition(int spillerPosition){
        gui.showMessage("Du er nu på felt nr: "+spillerPosition);
    ...
    public int chanceKortsVejledning(){
        int valg = gui.getUserInteger("Intast nummeret på det Chancekort du gerne vil aktivere");
        return valg;
    }
    ...
    public void overStart(int pos){
        gui.showMessage("Din position er: "+ pos+
                "\nDu har i din rundfart med taxaen kommet til at passere Start, og modtager derfor 200");
    }
